...
import { agregarPedidos, editarUsuario, obtenerUsuario } from "./ayudas/consultas";

const ModalPago = ({ setMostrarModal, totalCarrito, setMostrarCarrito }) => {
                    ...
                    <div className="modal_pasos d-flex justify-content-center align-items-center gap-1">
                        ...
                        >
                            <div
                                className="paso_circulo d-flex justify-content-center align-items-center"
                                style={{
                                    backgroundColor: mostrarConfirmarPago
                                        ? "#9DFFC1"
                                        : "#DDD",
                    ...
                    >
                        ...
                        <div className="d-flex justify-content-between mt-0">
                            ...
                            <div className="form_doble form-group">
                                ...
                                <p className="mb-0">
                                    Los 3 números del dorso de tu tarjeta
                                </p>
                            </div>
                        </div>
                        <div className="form-group">
                            <label htmlFor="dniTarjeta">
