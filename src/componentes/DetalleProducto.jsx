    ...
    <section>
      <article className="contenedor_detalle">
        ...
        <div className="d-flex flex-column flex-md-row">
          ...
          <h2 className="mt-0">$1000</h2>
          <p className="descripcion_detalle mb-0">
            ...
            ligeramente tostados se encuentran también una variedad de aderezos
            y condimentos, como lechuga crujiente, tomate fresco, cebolla,
            pepinillos y una irresistible salsa.
          </p>
          <hr />
          <h4>Tamaño</h4>
          ...
          <button className="agregar_carrito w-100">Agregar al carrito</button>
        </div>
      </article>
    </section>
  );
