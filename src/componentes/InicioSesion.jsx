...
const InicioSesion = ({ setUsuarioLogeado, usuarioLogueado }) => {
    ...
    /* no me funciona el ubicacion path name */
    const manejoEnvio = async (usuarioRegistrado) => {
        console.log("soy manejoEnvio", usuarioRegistrado);
        if (ubicacion.pathname === "/usuario/iniciar" && usuarioID && editar) {
            setEditar(true);
            ...
            if (
                ...
                iniciarSesion(usuarioRegistrado).then((respuesta) => {
                    console.log("me trae de iniciar sesion", respuesta);
                    setEditar(false);
                    if (respuesta) {
                ...
                // no funciona lo de entrar al path  usuario registrar
                if (ubicacion.pathname === "/usuario/registrar") {
                    console.log("entre a registar");
                    ...
                    console.log("soy nuevo usuario", nuevoUsuario);
